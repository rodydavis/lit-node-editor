 ...
 * http://polymer.github.io/PATENTS.txt
 */
const u=new WeakMap,f=e=>"function"==typeof e&&u.has(e),g={},m={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function M(e){let t=U.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},U.set(e.type,t));let i=t.stringsArray.get(e.strings);if(void 0!==i)return i;const n=e.strings.join(s);return i=t.keyString.get(n),void 0===i&&(i=new r(e,e.getTemplateElement()),t.keyString.set(n,i)),t.stringsArray.set(e.strings,i),i}const U=new Map,V=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,s,i){const n=t[0];if("."===n){return new C(e,t.slice(1),s).parts}if("@"===n)return[new T(e,t.slice(1),i.eventContext)];if("?"===n)return[new E(e,t.slice(1),s)];return new b(e,t,s).parts}handleTextExpression(e){return new P(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const R=(e,...t)=>new w(e,t,"html",$)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");const Z={};class K extends J{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(Array.isArray(e)){const t=(e,s)=>e.reduceRight(((e,s)=>Array.isArray(s)?t(s,e):(e.add(s),e)),s),s=t(e,new Set),i=[];s.forEach((e=>i.unshift(e))),this._styles=i}else this._styles=void 0===e?[]:[e];this._styles=this._styles.map((e=>{if(e instanceof CSSStyleSheet&&!D){const t=Array.prototype.slice.call(e.cssRules).reduce(((e,t)=>e+t.cssText),"");return new X(String(t),Y)}return e}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow(this.constructor.shadowRootOptions)}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?D?this.renderRoot.adoptedStyleSheets=e.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map((e=>e.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==Z&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)})))}render(){return Z}}K.finalized=!0,K.render=(e,s,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const n=i.scopeName,r=V.has(s),o=L&&11===s.nodeType&&!!s.host,a=o&&!j.has(n),d=a?document.createDocumentFragment():s;if(((e,s,i)=>{let n=V.get(s);void 0===n&&(t(s,s.firstChild),V.set(s,n=new P(Object.assign({templateFactory:M},i))),n.appendInto(s)),n.setValue(e),n.commit()})(e,d,Object.assign({templateFactory:z(n)},i)),a){const e=V.get(d);V.delete(d);const i=e.value instanceof y?e.value.template:void 0;F(n,d,i),t(s,s.firstChild),s.appendChild(d),V.set(s,e)}!r&&o&&window.ShadyCSS.styleElement(s.host)},K.shadowRootOptions={mode:"open"};class G{constructor(){this.nodes=[],this.edges=[]}static fromJson(e){const{nodes:t,edges:s}=JSON.parse(e),i=new G;return t&&(i.nodes=t),s&&(i.edges=s),i}toJson(){const e={nodes:this.nodes,edges:this.edges};return JSON.stringify(e,null,2)}getNodeIndex(e){return this.nodes.findIndex((t=>t.id===e))}createNode(e){const t=this.getNodeIndex(e.id);-1===t?this.nodes.push(e):this.nodes[t]=e}retrieveNode(e){return this.nodes.find((t=>t.id===e))}updateNode(e){const t=this.getNodeIndex(e.id);-1!==t&&(this.nodes[t]=e)}deleteNode(e){const t=this.getNodeIndex(e);-1!==t&&this.nodes.splice(t,1)}getEdgeIndex(e){return this.edges.findIndex((t=>t.id===e))}createEdge(e){const t=this.getEdgeIndex(e.id);-1===t?this.edges.push(e):this.edges[t]=e}retrieveEdge(e){return this.edges.find((t=>t.id===e))}updateEdge(e){const t=this.getEdgeIndex(e.id);-1!==t&&(this.edges[t]=e)}deleteEdge(e){const t=this.getEdgeIndex(e);-1!==t&&this.edges.splice(t,1)}linkNodes(e,t,s){const i=Math.random().toString(36).substring(2,15)+Math.random().toString(36).substring(2,15);this.createEdge({id:i,startNode:e.id,endNode:t.id,name:s})}}class Q{constructor(e){var t;this.store=new G,this.offset={x:0,y:0},this.scale=1,this.action=ee.NONE,this.selected=new Array,this.hovered=new Array,this.matrix=[1,0,0,1,0,0],this.invMatrix=[1,0,0,1],this.onUpdate=()=>{},this.canvas=null!=(t=null==e?void 0:e.canvas)?t:document.createElement("canvas"),this.resize(null==e?void 0:e.size),this.ctx=this.canvas.getContext("2d"),this.ctx.imageSmoothingEnabled=!0,this.init()}init(){this.render(),this.canvas.addEventListener("contextmenu",(function(e){e.preventDefault()}),!1),this.canvas.addEventListener("wheel",(e=>this.onWheel(e)),!1),this.canvas.addEventListener("mousedown",(e=>this.onMouseDown(e)),!1),this.canvas.addEventListener("mousemove",(e=>this.onMouseMove(e)),!1),this.canvas.addEventListener("mouseup",(e=>this.onMouseUp(e)),!1)}import(e){this.store=G.fromJson(e)}resize(e){this.size=null!=e?e:{width:window.innerWidth,height:window.innerHeight},this.canvas.setAttribute("width",`${this.size.width}px`),this.canvas.setAttribute("height",`${this.size.height}px`),this.canvas.width=this.size.width,this.canvas.height=this.size.height}onWheel(e){e.preventDefault(),e.ctrlKey?(this.action=ee.ZOOM,this.scale-=.01*e.deltaY):(this.action=ee.PAN,this.offset.x-=2*e.deltaX,this.offset.y-=2*e.deltaY),this.onUpdate(),this.action=ee.NONE}onMouseDown(e){this.lastOffset={x:e.offsetX,y:e.offsetY},this.action=ee.MOVE,this.clear();const t=this.getSelection(this.lastOffset);this.selected.push(...t),this.onUpdate()}onMouseUp(e){this.lastOffset=void 0,this.action=ee.NONE}onMouseMove(e){if(this.action===ee.MOVE&&this.selected.length>0){const t={x:e.offsetX-this.lastOffset.x,y:e.offsetY-this.lastOffset.y},s=this.selectedNode();s&&this.moveNode(s,t),this.lastOffset={x:e.offsetX,y:e.offsetY}}else this.checkHover({x:e.offsetX,y:e.offsetY})}checkHover(e){this.hovered.splice(0,this.hovered.length);const t=this.getSelection(e);this.hovered.push(...t);const s=this.hoveredNode();this.canvas.style.cursor=s?"pointer":"default"}moveNode(e,t){e.x+=t.x/this.scale,e.y+=t.y/this.scale,this.store.updateNode(e)}selectedNode(){if(0===this.selected.length)return;const e=this.selected[this.selected.length-1];return this.store.retrieveNode(e)}hoveredNode(){if(0===this.hovered.length)return;const e=this.hovered[this.hovered.length-1];return this.store.retrieveNode(e)}clear(){this.selected.splice(0,this.selected.length),this.onUpdate()}getSelection(e){const t=new Array,s=this.toWorld(e.x,e.y);for(const i of this.store.nodes)s.x>=i.x&&s.x<=i.x+i.width&&s.y>=i.y&&s.y<=i.y+i.height&&t.push(i.id);return t}render(){this.paint(),requestAnimationFrame((()=>this.render()))}paint(){this.ctx.setTransform(1,0,0,1,0,0),this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.renderBackground(),this.createMatrix(this.offset.x,this.offset.y,this.scale,0);const e=this.matrix;this.ctx.setTransform(e[0],e[1],e[2],e[3],e[4],e[5]),this.renderEdges(),this.renderNodes()}renderBackground(){this.ctx.save(),this.ctx.fillStyle="whitesmoke",this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height),this.ctx.restore()}createMatrix(e,t,s,i){const n=this.matrix,r=this.invMatrix;n[3]=n[0]=Math.cos(i)*s,n[2]=-(n[1]=Math.sin(i)*s),n[4]=e,n[5]=t;const o=n[0]*n[3]-n[1]*n[2];r[0]=n[3]/o,r[1]=-n[1]/o,r[2]=-n[2]/o,r[3]=n[0]/o}toWorld(e,t){let s,i,n;return n=this.invMatrix,s=e-this.matrix[4],i=t-this.matrix[5],{x:s*n[0]+i*n[2],y:s*n[1]+i*n[3]}}renderNodes(){for(const e of this.store.nodes)this.renderNode(e)}renderEdges(){for(const e of this.store.edges)this.renderEdge(e)}renderNode(e){var t,s,i;this.ctx.save(),this.ctx.moveTo(e.x,e.y);const n=(null==(t=this.selectedNode())?void 0:t.id)===e.id,r=(null==(s=this.hoveredNode())?void 0:s.id)===e.id;this.scopedPaint((t=>{t.translate(e.x,e.y-5),t.font="12px Arial",t.textAlign="left",t.fillStyle="black",t.fillText(e.name,0,0)})),this.ctx.fillStyle=null!=(i=null==e?void 0:e.backgroundColor)?i:"white",this.ctx.fillRect(e.x,e.y,e.width,e.height),this.ctx.strokeStyle=n?"red":r?"blue":"black",this.ctx.strokeRect(e.x,e.y,e.width,e.height),this.ctx.restore()}renderEdge(e){this.ctx.save();const t=this.store.retrieveNode(e.startNode),s=this.store.retrieveNode(e.endNode),i={x:t.x+t.width/2,y:t.y+t.height/2,width:t.width,height:t.height},n={x:s.x+s.width/2,y:s.y+s.height/2,width:s.width,height:s.height};this.scopedPaint((e=>{e.beginPath(),e.strokeStyle="black",e.moveTo(i.x,i.y),e.bezierCurveTo(i.x+i.width/2,i.y,n.x-n.width/2,n.y,n.x,n.y),e.stroke()})),this.ctx.restore()}scopedPaint(e){this.ctx.save(),e(this.ctx),this.ctx.restore()}}var ee,te;(te=ee||(ee={}))[te.NONE=0]="NONE",te[te.ZOOM=1]="ZOOM",te[te.PAN=2]="PAN",te[te.MOVE=3]="MOVE";var se=Object.defineProperty,ie=Object.getOwnPropertyDescriptor;"undefined"!=typeof require&&require;let ne=class extends K{constructor(){super(...arguments),this.editor=new Q({size:{width:window.innerWidth-200,height:window.innerHeight}})}render(){return R`<main>
      <div id="output">${this.editor.canvas}</div>
      <div id="properties">
        <span class="title">Properties</span>
        ${this.renderProperties()}
      </div>
    </main>`}renderProperties(){var e;const t=this.editor.selectedNode();return t?R`
      <div class="property">
        <label>Name</label>
        <input
          type="text"
    ...
    `:R`<div>
        ...
        <div class="property">
          <button
            @click=${()=>{const e=this.addRandomNode();this.editor.selected.push(e.id),this.requestUpdate()}}
          >
            Add new node
          </button>
        </div>
...
*/ne.styles=((e,...t)=>{const s=t.reduce(((t,s,i)=>t+(e=>{if(e instanceof X)return e.cssText;if("number"==typeof e)return e;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${e}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(s)+e[i+1]),e[0]);return new X(s,Y)})`
    main {
      display: flex;
      flex-direction: row;
    }
